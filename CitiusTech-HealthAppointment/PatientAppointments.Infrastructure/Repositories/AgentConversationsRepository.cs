...
{
    public class AgentConversationsRepository : GenericRepository<AgentConversations>, IAgentConversationsRepository
    {
        public AgentConversationsRepository(AppDbContext ctx) : base(ctx) { }
    }
}
